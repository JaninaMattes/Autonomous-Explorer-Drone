...
def run(env_id=DEFAULT_ENV, 
    ...
    if algo == 'ppo_sb3':
        ...
        trainer = PPOTrainer(
                    env, 
                    total_training_steps=training_steps, # shorter just for testing
                    epsilon=0.22,
                    seed=seed) 
        # train PPO
...
if __name__ == "__main__":
    ...
    parser.add_argument('--training_steps',     default=DEFAULT_TRAINING_STEPS, type=int,            help='Select an environment to train on (hover, takeoff)')
