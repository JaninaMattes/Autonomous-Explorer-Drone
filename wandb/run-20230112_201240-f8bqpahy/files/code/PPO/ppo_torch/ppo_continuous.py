...
class PPO_PolicyGradient_V2:
    ...
    def learn(self):
        ...
        if self.stats_plotter:
            ...
            self.stats_plotter.plot_seaborn_fill(df, row='mean episodic returns', y_min='min episodic returns', y_max='max episodic returns',  title=f'{env_name}', x_label='Timestep', y_label='Mean Episodic Return', color='blue')
