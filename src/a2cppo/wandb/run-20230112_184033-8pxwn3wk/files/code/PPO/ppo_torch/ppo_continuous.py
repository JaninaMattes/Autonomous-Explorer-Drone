    ...
    def learn(self):
        ...
        while training_steps < self.total_training_steps:
            ...
            if training_steps % self.save_model == 0:
                ...
                env_model_path = os.path.join(self.exp_path, 'model')
                print(env_model_path)
                policy_net_name = f'{env_model_path}{env_name}_{CURR_TIME}_policyNet.pth'
                value_net_name = f'{env_model_path}{env_name}_{CURR_TIME}_valueNet.pth'
                torch.save({
...
if __name__ == '__main__':
    ...
    # create model folder
    model_path = os.path.join(exp_folder_name, 'model')
