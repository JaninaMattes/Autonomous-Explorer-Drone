...
def test(model_path, env, in_dim, out_dim, n_steps=1000, device='cpu', log_video=True, filename='pendulum_v1.gif'):
    ...
    for ep_num in range(0, n_steps):
        ep_len, ep_ret, frames = simulate_rollout(policy_net, env, render)
