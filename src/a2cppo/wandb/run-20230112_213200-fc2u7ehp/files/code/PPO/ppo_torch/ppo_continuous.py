...
class PPO_PolicyGradient_V2:
    ...
    def learn(self):
        ...
        if self.stats_plotter:
            ...
            self.stats_plotter.plot_seaborn_fill(df, x='timestep', y='mean episodic returns', y_min='min episodic returns', y_max='max episodic returns',  title=f'{env_name}', x_label='Timestep', y_label='Mean Episodic Return', color='blue')
...
if __name__ == '__main__':
    ...
    # Hyperparameter
    total_training_steps = 3000_000     # time steps regarding batches collected and train agent
