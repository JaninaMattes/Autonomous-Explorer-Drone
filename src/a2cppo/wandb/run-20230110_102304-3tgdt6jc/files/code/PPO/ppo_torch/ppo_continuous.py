...
class PPO_PolicyGradient_V1:
    ...
    def __init__(self, 
        ...
        self.stats_data = {'experiment name': [], 'mean episodic length': [], 'mean episodic rewards': [], 'timestep': []}
...
if __name__ == '__main__':
    ...
    wandb.init(
            ...
            name=f"exp_name: {env_name}_{CURR_DATE}_{args.exp_name}", # needs flag --exp-name
            monitor_gym=True,
            save_code=True
        )
